...
public class SqlSessionFactoryCreator {
    ...
    public synchronized SqlSessionFactory createSqlSessionFactory(DataSource dataSource) {
        ...
        //执行拷贝操作
//        BeanUtils.copyProperties(originConfiguration, mybatisConfiguration, CopyOptions.create().ignoreError());
//        BeanUtils.copyProperties(originGlobalConfig, globalConfig, CopyOptions.create().ignoreError());
        ...
        try {
            ...
            throw new ArithmeticException( "初始化SqlSessionFactory错误！");
        }
    }
